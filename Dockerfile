...
RUN wget --no-check-certificate https://dev.mysql.com/get/Downloads/Connector-J/mysql-connector-java-5.1.33.tar.gz -O - | tar -xz -C /jboss-as-7.1.1.Final/standalone/deployments/ --strip-components=1 mysql-connector-java-5.1.33/mysql-connector-java-5.1.33-bin.jar
